...
const Sidebar = () => {
  ...
  return (
    <div 
      className='ml-3 h-screen md:overflow-hidden overflow-auto md:hover:overflow-auto pb-auto'>
        {activeMenu && (<>
          <div className='flex justify-between items-center'>
            ...
            <TooltipComponent content='Menu' position='BottomCenter'>
              <button type='button' onClick={() => setActiveMenu( (prevActiveMenu) => !prevActiveMenu)}
                className='text-xl rounded-full p-3 hover:bg-light-gray mt-3 block md:hidden'
              >
                <MdOutlineCancel/>
              </button>
            </TooltipComponent>
